...
export default function NavShell({
  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="p-1.5 text-ink transition hover:text-charcoal lg:hidden"
          >
      ...
      <div
        className={`fixed inset-0 z-50 bg-charcoal text-stone transition-opacity duration-300 lg:hidden ${
      ...
      >
        <div className="flex items-center justify-between px-4 py-4 sm:px-6">
          ...
          <button
            ...
            className="p-1.5 text-stone"
          >
            <Icon name="close" className="text-2xl" />
          </button>
        </div>
        <nav className="flex flex-col gap-1 px-4 pt-8 sm:px-6">
          {links.map((l, i) => (
            <Link
              key={l.href}
              href={l.href}
        ...
        <div className="mt-10 flex flex-col gap-3 px-4 sm:px-6">
          <Link
            href="/rooms"
            onClick={() => setMenuOpen(false)}
            className="label-caps flex items-center justify-center bg-stone px-6 py-4 text-ink"
          >
            Check Availability
          </Link>
          {whatsappNumber && (
            <a
              ...
              className="label-caps flex items-center justify-center gap-2 border border-stone/30 px-6 py-4 text-stone"
            >

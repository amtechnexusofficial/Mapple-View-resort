...
export default async function AdminSettingsPage() {
  ...
  return (
    <div>
      <h1 className="font-display text-2xl font-bold text-forest-800">Settings</h1>
      ...
      <div className="mt-8 rounded-2xl border border-forest-100 bg-white p-6 shadow-sm">
